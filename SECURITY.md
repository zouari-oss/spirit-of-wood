# Security Policy for spirit-of-wood

## Supported Versions

The spirit-of-wood project provides security updates for the following versions:
...
If you discover a security vulnerability in spirit-of-wood, we encourage responsible disclosure. To report a vulnerability:
...
We appreciate the security community's efforts in helping us maintain spirit-of-wood’s safety and integrity.

## Security Practices

spirit-of-wood follows industry best practices for security to ensure safe transactions and protect user data:

### 1. **Authentication and Authorization**

- spirit-of-wood uses secure methods for user authentication, including strong password hashing (e.g., bcrypt).
...
Contributors can help enhance spirit-of-wood's security by following these practices:
...
Thank you for helping us make spirit-of-wood secure for our users and the community!
